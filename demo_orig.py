...
TOP10K_FPATH = BASE_DIR + "/dataset/tranco_0609.csv"
TOP10K_FPATH_HTML = "/data2/shine/a4_pipeline/ad_Nbackdoor/rendering_stream/map_local_list_unmod_final.csv"
sites_all = read_url_list(TOP10K_FPATH_HTML)[:100]
