...
def deploy_firefox(
    ...
    # shine
    port_num = browser_params.port_num
    proxy = {
        'proxyType': 'MANUAL',
        'httpProxy': "127.0.0.1:{}".format(port_num),
        'sslProxy': "127.0.0.1:{}".format(port_num),
    }
    fo.capabilities['proxy'] = proxy
